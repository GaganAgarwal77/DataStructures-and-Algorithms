...
int patternMatching(char* text,char*patterns,int len_pat)
{
    ...
    for (int i = 0; i < strlen(patterns) - len_pat + 1; i++)
    {
        int N=0;
        int a =0;
...
int main()
{
    // char* text = "101110101110110011101000000000000";//01110110011110101110110011101111010111011101011101100111010111011001111010111011";
    // char*patterns = "11111";//010111011110110011101";//0011101011101100";
    ...
    patternMatching(text,patterns,32);
