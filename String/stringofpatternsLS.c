...
// char* patterns = "1";//11111";//010111011110110011101";//0011101011101100";
...
int LinearSearch(int l)
{

    int i =1;
    for(i =1;i<l+1;i++)
    {
        if(patternMatching(i) == 1)
        {
            printf("Found pattern match for length l = %d\n",i);
        }
        else
        {
            printf("No pattern match for length l = %d\n",i);
            break;
        }
    }
    if(i==1)
